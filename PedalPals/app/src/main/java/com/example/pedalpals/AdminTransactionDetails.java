...
public class AdminTransactionDetails extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    TextView name_tv, email_tv, hall_tv, user_rating_tv, mobile_tv;
    TextView owner_name_tv, owner_email_tv, owner_hall_tv, owner_rating_tv, owner_mobile_tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        owner_name_tv = findViewById(R.id.owner_name);
        owner_email_tv = findViewById(R.id.owner_email);
        owner_hall_tv = findViewById(R.id.owner_hall);
        owner_rating_tv = findViewById(R.id.owner_rating);
        owner_mobile_tv = findViewById(R.id.owner_mobile);
    ...
    private void logout(){
        AlertDialog.Builder builder=new AlertDialog.Builder(AdminTransactionDetails.this);
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                Intent i = new Intent(AdminTransactionDetails.this, MainActivity.class);
                startActivity(i);
    ...
    private void showData(){
        ...
        StringBuffer bf_owner = new StringBuffer();
        res = db.getData_User_username(owner);
        while(res.moveToNext()){
            bf_owner.append(res.getString(1) + ";");
            bf_owner.append(res.getString(2) + ";");
            bf_owner.append(res.getString(3) + ";");
            bf_owner.append(res.getString(4) + ";");
            bf_owner.append(res.getString(5) + ";");
            bf_owner.append(res.getString(7) + ";");
            bf_owner.append(res.getString(8) + "\n");
        }

        String[] str_owner = bf_owner.toString().split(";");
        ...
        owner_name_tv.setText(str_owner[0] + " " + str_owner[1]);
        owner_email_tv.setText(str_owner[2]);
        owner_hall_tv.setText(str_owner[4] + " " + str_owner[3]);
        owner_mobile_tv.setText(str_owner[6]);
        if(str_owner[5].isEmpty() || str_owner[5].equals("0"))
            owner_rating_tv.setText("NA");
        else
            owner_rating_tv.setText(str_owner[5]);
